 ...
 <div class="widget-box">
          ...
          <div class="widget-content">
            <ul class="unstyled">
              ...
              <li> <span class="icon24 icomoon-icon-arrow-down-2 red"></span> <?php echo number_format(($totalt/$total)*100, 2, ',', ''); ?>% TD <span class="pull-right strong"><?php echo $totalt; ?></span>
