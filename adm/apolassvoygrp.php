            ...
            while ($row_res=$rqt->fetch()){  ?>
                ...
                <tr class="gradeX">
                    ...
                    <td>&nbsp;
                        ...
                        <?php if($row_res['etat']==0){ ?>
                            &nbsp;&nbsp;&nbsp;
                            <a onClick="advavvoy('<?php echo $row_res['cod_pol'];?>','<?php echo $row_res['ndat_eff'];?>','apolassvoygrp.php')" title="Avenant"><i CLASS="icon-edit icon-2x " style="color:#BA1E20" /></a>
                        <?php } ?>
                        &nbsp;&nbsp;&nbsp;
                        <a onClick="adlav('<?php echo $row_res['cod_pol'];?>','avpolvoygrp.php')" title="Liste-Avenants"><i CLASS="icon-list-alt icon-2x" style="color:black"/></a>
