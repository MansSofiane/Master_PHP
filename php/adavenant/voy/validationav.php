...
$seq++;
	...
	$rqtds=$bdd->prepare("SELECT u.id_user AS id_user, u.com AS com FROM  `utilisateurs` u, souscripteurw s WHERE s.id_user = u.id_user and s.cod_sous = '$cod_sous'");

  echo "SELECT u.id_user AS id_user, u.com AS com FROM  `utilisateurs` u, souscripteurw s WHERE s.id_user = u.id_user and s.cod_sous = '$cod_sous'";
...
//mise a jour modif
	$rqtassur=$bdd->prepare("UPDATE modif set cod_av='$cod_av' where cod_pol='$code' and id_user='$iduserad' and cod_par='$cod_sous'");
	echo "UPDATE modif set cod_av='$cod_av' where cod_pol='$code' and id_user='$iduserad' and cod_par='$cod_sous'";
	$rqtassur->execute();

	// inserer le resultat dans assure

	$rqtassur=$bdd->prepare("insert into assure (`nom_assu`, `pnom_assu`, `passport`, `datedpass`, `datefpass`, `mail_assu`, `tel_assu`, `adr_assu`, `age_assu`, `sexe`, `cod_sous`, `cod_pol`, `cod_av`, `id_user`, `cod_par` , `modif_sous`) (select `nom_assu`, `pnom_assu`, `passport`, `datedpass`, `datefpass`, `mail_assu`, `tel_assu`, `adr_assu`, `age_assu`, `sexe`, `cod_sous`, `cod_pol`, `cod_av`, `id_user`, `cod_par` , `modif_sous` from  modif where cod_pol='$code' and id_user='$iduserad' and cod_par='$cod_sous')");
	echo "insert into assure (`nom_assu`, `pnom_assu`, `passport`, `datedpass`, `datefpass`, `mail_assu`, `tel_assu`, `adr_assu`, `age_assu`, `sexe`, `cod_sous`, `cod_pol`, `cod_av`, `id_user`, `cod_par` , `modif_sous`) (select `nom_assu`, `pnom_assu`, `passport`, `datedpass`, `datefpass`, `mail_assu`, `tel_assu`, `adr_assu`, `age_assu`, `sexe`, `cod_sous`, `cod_pol`, `cod_av`, `id_user`, `cod_par` , `modif_sous` from  modif where cod_pol='$code' and id_user='$iduserad' and cod_par='$cod_sous')";
	$rqtassur->execute();

	//supprimer modif

	$rqtassur=$bdd->prepare("delete from  modif  where cod_pol='$code' and id_user='$iduserad' and cod_par='$cod_sous'");
	$rqtassur->execute();

echo "fin d'insertion";
}
