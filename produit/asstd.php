          ...
          <div class="widget-content nopadding">
			...
			<tr class="gradeX">
				...
				<td><?php echo $row_res['cod_dev']; ?></td>
				  ...
				  <?php if($row_res['bool']==0){ ?>
			       <a onClick="vdev('<?php echo $row_res['cod_dev'];?>','<?php echo $row_res['dat_eff'];?>','asstd.php')" title="Valider"><img  src="img/icons/ok.png"/></a>&nbsp;&nbsp;&nbsp;
				  <?php } ?>
				  <a onClick="ddev('prod','asstd.php','<?php echo $row_res['cod_dev'];?>')" title="Supprimer"><img  src="img/icons/supp.png"/></a>
				  </td>
                </tr>
			<?php } ?>
              </tbody>
