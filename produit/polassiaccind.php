          ...
          <div class="widget-content nopadding">
			...
			<tr class="gradeX">
				...
				<td><?php echo $row_res['sequence']; ?></td>
				  ...
				  <a href="sortie/contrat2/<?php echo crypte($row_res['cod_pol']) ?>" onClick="window.open(this.href, 'Devis', 'height=600, width=800, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, directories=no, status=no'); return(false);" title="Imprimer"><i CLASS="icon-print icon-2x" style="color:#0e90d2"/></a> <?php if($row_res['etat']==0){ ?>
				  &nbsp;&nbsp;&nbsp;
