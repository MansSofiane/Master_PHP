...
$trouve1=0;$trouve2=0;
    ...
    if($trouve1==1 && $trouve2==1) {
        ...
        $reqinsrt = $bdd->prepare("INSERT INTO `devisw` ( `dat_dev`, `cod_tar`, `cod_prod`, `cod_per`, `cod_opt`, `cod_zone`, `cod_pays`, `cod_formul`, `cod_dt`, `cod_cpl`, `dat_eff`, `dat_ech`, `cap1`, `cap2`, `cap3`, `p1`, `p2`, `p3`, `pn`, `pt`, `bool`, `etat`, `cod_sous`, `taux_int`, `diff_pay`, `com`)
         VALUES ('$datesys','','1','$cod_per','$option','$cod_zone','$pay','3','2','2','$dateffet','$datech','0','0','0','$pa', '$pg', '0', '$pn', '$pt', '0', '0', '$codsous', '', '','$com')");
        $reqinsrt->execute();
        echo '1';
    }else
    {
