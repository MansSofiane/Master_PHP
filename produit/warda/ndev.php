...
$rqtidwar=$bdd->prepare("INSERT INTO `devisw` VALUES ('', '$datesys', '$tar', '$cod_prod', '$cod_per', '$cod_opt', '$cod_zone','DZ', '$cod_formul', '$cod_dt', '$cod_cpl', '$d1', '$d2','0', '0', '0', '0', '0', '0', '$pn', '$pt', '$bool', '0', '$sous','','','$com')");
$rqtidwar->execute();
